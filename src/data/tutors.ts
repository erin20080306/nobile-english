...
export const TUTORS: TutorProfile[] = [
  ...
  },
  {
    ...
    ttsVoice: "alloy",
    ttsInstructions: "Speak like a Chinese woman English teacher speaking English. Use clear understandable English with a natural light Mandarin accent, warm classroom energy, and strong clear volume. Do not sound raspy or muffled.",
    ttsVolumeGain: 1.62,
    description: "中國人說英文聲音，清楚好懂，也了解中文學習者問題",
    avatarSeed: "Lily",
    avatarBg: "#FFE4E6",
    photoUrl: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=520&q=90",
