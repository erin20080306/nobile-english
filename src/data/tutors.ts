...
export const TUTORS: TutorProfile[] = [
  ...
  },
  {
    ...
    flag: "🇨🇳",
    lang: "en-US",
    voiceKeywords: ["meijia", "ting-ting", "samantha", "en-us"],
    ttsVoice: "nova",
    ttsInstructions: "Speak like a sweet, warm Chinese woman English teacher. Use clear understandable English with a very light Mandarin accent, bright gentle energy, smooth pronunciation, and strong clear volume. Sound friendly and pleasant, never raspy, muffled, flat, or robotic.",
    ttsVolumeGain: 1.62,
